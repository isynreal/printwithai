...
export const SAMPLE_PLAYERS = [
  ...
  { id: 'p4', name: '小志', avatar: '志', color: '#68b69b' },
]

export const RESULT_SEEDS = [
  { name: '小明', score: 91, description: '輪廓完整，葉子與果梗都畫得很清楚！', emoji: '🍎' },
  { name: '小華', score: 78, description: '顏色很有創意，已抓到蘋果的圓潤外型。', emoji: '🍏' },
  { name: '小志', score: 64, description: '線條很有個性，再加一片葉子會更像喔。', emoji: '✏️' },
]
